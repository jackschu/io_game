...
goog.exportSymbol('proto.ClientMessage.DataCase', null, global);
...
proto.AnyMessage.prototype.setState = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.AnyMessage.oneofGroups_[0], value);
};
...
proto.AnyMessage.prototype.setStart = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.AnyMessage.oneofGroups_[0], value);
};
...
proto.AnyMessage.prototype.setJoin = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.AnyMessage.oneofGroups_[0], value);
};
  ...
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readUint32, jspb.BinaryReader.prototype.readMessage, proto.Player.deserializeBinaryFromReader, 0, new proto.Player());
         });
      break;
    case 3:
...
/**
 * @param {number} value
 * @return {!proto.Ball} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.GameStart} returns this
 */
...
proto.GameStart.prototype.getWall = function() {
  return /** @type {!proto.Wall} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
...
proto.PlayerJoin.toObject = function(includeInstance, msg) {
  var f, obj = {
    playerwallsMap: (f = msg.getPlayerwallsMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.PlayerJoin.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PlayerJoin.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
...
proto.PlayerJoin.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPlayerwallsMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.PlayerJoin} returns this
 */
proto.PlayerJoin.prototype.clearPlayerwallsMap = function() {
  this.getPlayerwallsMap().clear();
  return this;};
 ...
 * @return {number}
 */
proto.Ping.prototype.getTimestamp = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.Ping.prototype.setTimestamp = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
...
/**
 * @return {proto.ClientMessage.DataCase}
 */
proto.ClientMessage.prototype.getDataCase = function() {
  return /** @type {proto.ClientMessage.DataCase} */(jspb.Message.computeOneofCase(this, proto.ClientMessage.oneofGroups_[0]));
};
 ...
 * @return {?proto.Player}
 */
proto.ClientMessage.prototype.getPlayer = function() {
...
*/
proto.ClientMessage.prototype.setPlayer = function(value) {
 ...
 * @return {!proto.ClientMessage} returns this
 */
proto.ClientMessage.prototype.clearPlayer = function() {
 ...
 * @return {boolean}
 */
proto.ClientMessage.prototype.hasPlayer = function() {
  return jspb.Message.getField(this, 1) != null;
};
