    ...
    proto.GameState.toObject = function(includeInstance, msg) {
        var f,
            obj = {
                ball:
                    (f = msg.getBall()) &&
                    proto.Ball.toObject(includeInstance, f),
                playersMap: (f = msg.getPlayersMap())
                    ? f.toObject(includeInstance, proto.Player.toObject)
                    : [],
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            case 1:
                ...
                reader.readMessage(
                    value,
                    proto.Ball.deserializeBinaryFromReader
                );
                msg.setBall(value);
                break;
            case 2:
                ...
                reader.readMessage(value, function(message, reader) {
                    jspb.Map.deserializeBinary(
                        ...
                        proto.Player.deserializeBinaryFromReader,
                        ''
                    );
                });
                break;
...
proto.GameState.prototype.getBall = function() {
    return /** @type{?proto.Ball} */ (jspb.Message.getWrapperField(
        this,
        proto.Ball,
        1
    ));
...
proto.GameState.prototype.getPlayersMap = function(opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,!proto.Player>} */ (jspb.Message.getMapField(
        this,
        2,
        opt_noLazyCreate,
        proto.Player
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.Player.toObject = function(includeInstance, msg) {
        var f,
            obj = {
                xpos: jspb.Message.getFloatingPointFieldWithDefault(
                    msg,
                    1,
                    0.0
                ),
                ypos: jspb.Message.getFloatingPointFieldWithDefault(
                    msg,
                    2,
                    0.0
                ),
...
proto.Player.prototype.getWall = function() {
    return /** @type {!proto.Player.Wall} */ (jspb.Message.getFieldWithDefault(
        this,
        3,
        0
    ));
    ...
    proto.Ball.toObject = function(includeInstance, msg) {
        var f,
            obj = {
                ...
                zpos: jspb.Message.getFloatingPointFieldWithDefault(
                    msg,
                    3,
                    0.0
                ),
                xvel: jspb.Message.getFloatingPointFieldWithDefault(
                    msg,
                    4,
                    0.0
                ),
                yvel: jspb.Message.getFloatingPointFieldWithDefault(
                    msg,
                    5,
                    0.0
                ),
                zvel: jspb.Message.getFloatingPointFieldWithDefault(
                    msg,
                    6,
                    0.0
                ),
